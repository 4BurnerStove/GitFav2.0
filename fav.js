...
export class FavoritesView extends Favorites {
  constructor(root) {
    ...
    this.tbody = this.root.querySelector('table .UsersTable')
    this.tbodyEmpty = this.root.querySelector('#TableInitialBody')
  ...
  emptyPage() {
    const empyPage = document.querySelector('.trEmpty')

    if (this.entries == null) {
      empyPage.classList.remove('hide')
    }
    if (this.entries != null) {
      empyPage.classList.add('hide')
    }
  }
